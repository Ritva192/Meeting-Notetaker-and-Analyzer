...
def summary():
    ...
    file1=open("D:\SEM-8\FINAL PROJECT CODE\FR(Version 2)\myfile.txt","w")
    file1.write(data)
    file1.close()
    conn = mc.connect(user="root", password="", host="localhost", database="meetingdata")
    cur = conn.cursor()
    print(meeting)
    sql="SELECT email FROM meeting_member"
#sql2="SELECT  FROM member"
    print(sql)
...
##    result = tuple(result)
##    print(a)
    fromaddr = "krishnaahire24@gmail.com"
    #toaddr = result
    to = ('krishnaahire24@gmail.com', 'ritu234.fetr@gmail.com')
    #toaddr=', '.join(result)
    toaddr=to
    msg = MIMEMultipart()   
    msg['From'] = fromaddr 
...
##    cur = conn.cursor()
##    print(meeting)
##    sql="SELECT * FROM meeting_member WHERE meeting_id = %s"
###sql2="SELECT  FROM member"
##    print(sql)
##    #cur.execute(sql,(meeting))
##    cur.execute('''SELECT * FROM meeting_member WHERE meeting_id = (?)''', (meeting,))
##    result=cur.fetchall()
##    print(result)
##    for i in result:
##        if(i[1]==meeting):
##            print(i[4])
    #conn = mc.connect(user="root", password="", host="localhost", database="meetingdata")
    #cursor = conn.cursor()
##    sql2="SELECT * FROM meeting_member WHERE meeting_id = %s"
###sql2="SELECT lname FROM member"
##    data=str(p[0])
##    print(sql2,(data))
##    cur.execute(sql2)
...
##    d=str(p[0])
##    print(d)
##    query_string = "SELECT * FROM meeting_member"
